...
# Get po_date and selected_flag from command-line arguments or use default
po_date = sys.argv[1] if len(sys.argv) > 1 else get_date()
selected_flag = sys.argv[2] if len(sys.argv) > 2 else "skip all"
po_date='2024-12-25'
...
pdf_extractor = PDFExtractor(str(po_date), selected_flag)
